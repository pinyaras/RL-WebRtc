...
async def offer(request):
    ...
    def on_datachannel(channel: RTCDataChannel):
        ...
        async def sendStats():
            ...
            # COMMENTED OUT FOR NAMESPACE TEST
        ...
        async def on_message(message):
            ...
            if isinstance(message, str) and message.startswith("target_bitrate"):
                try:
                    ...
                    # AND LOG THE VALUE
                    with open('bitrate.txt', 'w') as f:
                        f.write(
                            "Target FPS: "+str(reduced_video_track.target_fps)+"\n"+
                            "Target Bitrate: "+str(target_bitrate)+"\n"+
                            "Updated encoder bitrate: "+str(video_sender._RTCRtpSender__encoder.target_bitrate)+"\n"+
                            "Bitrate target: "+str(target_bitrate)+" / "+str(video_sender._RTCRtpSender__encoder.target_bitrate)+"\n"
                        )
                    f.close()
